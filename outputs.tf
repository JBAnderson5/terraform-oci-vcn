...
output "drg_id" {
  ...
  value       = join(",", data.oci_core_drg.drg[*].id)
}
...
output "internet_gateway_id" {
  ...
  value       = join(",", data.oci_core_internet_gateway.ig[*].id)
}

output "service_gateway_id" {
  description = "id of service gateway if it is created"
  value       = join(",", data.oci_core_service_gateway.service_gateway[*].id)
}

output "ig_route_id" {
  description = "id of internet gateway route table"
  value       = join(",", data.oci_core_route_table.ig[*].id)
}

output "nat_route_id" {
  description = "id of VCN NAT gateway route table"
  value       = join(",", data.oci_core_route_table.nat[*].id)
}
...
output "nat_route_all_attributes" {
  ...
  value       = { for k, v in data.oci_core_route_table.nat : k => v }
}

output "service_gateway_all_attributes" {
  description = "all attributes of created service gateway"
  value       = { for k, v in data.oci_core_service_gateway.service_gateway : k => v }
}
